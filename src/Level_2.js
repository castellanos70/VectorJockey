class Level_2
{
    ...
    init()
    {
        ...
        minY = -5000;
        maxY = 5000;
        let ship = new Ship(new Coord(0, 0), false, thrusts);
        shipList.push(ship);
    ...
    getNextHelpMsg()
    {
        ...
        {   //@formatter:off
            ...
            case 103: return "An object at rest stays at rest and an object in motion stays in motion ...";
            case 105: return "... with the same speed and same direction unless acted upon by an unbalanced force.";
            case 107: return "Cars turn & break using friction between tires & road.";
            case 108: return "Airplanes turn & break using ailerons & rudders pushing on air.";
            case 109: return "In empty space, there is nothing to push on.";
            case 110: return "                                                               ";
